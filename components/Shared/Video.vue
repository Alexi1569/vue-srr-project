<template>
  <div :class="['video__block', playerClass]">
    ...
    <div
      ...
      ref="wrap"
      v-in-viewport
      class="video__block-inner flex ai-c jc-c"
    >
      <transition name="controls-fade">
        <button
          @click="toggleVideo"
          v-show="!isPlaying || showControls"
          class="video__block-toggler inline-flex ai-c jc-c"
        >
          <svg
            v-if="!isPlaying"
          ...
          <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="-37 0 320 320.00002">
            <path
              d="m96.398438 0h-86.398438c-5.515625.015625-9.984375 4.484375-10 10v300c.015625 5.515625 4.484375 9.984375 10 10h86.398438c5.519531-.015625 9.984374-4.484375 10-10v-300c-.015626-5.515625-4.480469-9.984375-10-10zm0 0"
            ></path>
            <path
              d="m236.898438 0h-86.5c-5.515626.015625-9.984376 4.484375-10 10v300c.015624 5.515625 4.484374 9.984375 10 10h86.402343c5.515625-.015625 9.984375-4.484375 10-10v-300c.03125-2.644531-1-5.191406-2.859375-7.070312-1.859375-1.878907-4.398437-2.93359425-7.042968-2.929688zm0 0"
            ></path>
          </svg>
        </button>
      </transition>
      ...
      <video @timeupdate="updateTime" @ended="isPlaying = false" ref="video" :poster="video.poster">
        <source v-for="item, i in video.items" :src="item.src" :type="item.type">
      </video>
      <transition name="controls-fade">
        <div v-show="showControls" class="video__block-controls flex ai-c jc-sb">
          ...
          <div :class="{'disabled': !withSound}" class="volume flex ai-c jc-fs">
          ...
          <button @click="toggleFullScreen" class="fullscreen">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 513.32 513.32">
              <path
                d="M177.523 305.853L42.777 440.6v-98.387H0V513.32h171.107v-42.777H74.859l134.746-134.746z"
              ></path>
              <path
                d="M470.543 440.6L72.72 42.777h98.387V0H0v171.107h42.777V72.72L440.6 470.543h-98.387v42.777H513.32V342.213h-42.777z"
              ></path>
              <path
                d="M342.213 0v42.777h100.526L307.992 177.523l29.943 29.944L470.543 74.859v96.248h42.777V0z"
              ></path>
            </svg>
          </button>
        </div>
...
.video__block--faq .video__block-inner {
  opacity: 0;
  transition: 1.4s all cubic-bezier(0.19, 1, 0.22, 1);
...
.video__block-toggler {
  ...
  height: 32px;
  box-shadow: 0px 0px 0px 8px rgba(13, 162, 213, 0.3);
}
