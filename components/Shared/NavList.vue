<template>
  <nav class="nav__wrap">
    <ul :class="['nav__list', classObject]" v-in-viewport>
      <NavItem
  ...
  computed: {
    classObject() {
      return {
        ...
        "s-services__nav-list flex fw-w jc-fs":
          this.view === "SECTION_SERVICES",
...
.sidebar__nav-list {
  letter-spacing: 0.025em;
  font-family: "Futura PT heavy";
  padding: 2.8125rem 8.125rem 0 5.3125rem;
