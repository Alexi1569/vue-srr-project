<template>
  <div
    :class="['sidebar flex fd-c ai-s jc-sb', {'opened': sidebar.isOpened}]"
  >
    <SideBarToggler
      view="SIDEBAR"
    ...
    <div class="flex sidebar__right-wrap fd-c ai-fs jc-sb">
      ...
      <div class="sidebar__bottom flex fd-c ai-s jc-sb">
        <SideBarLanguages
          :languages="sidebar.data.languages"
        />
        <SocialsList
          :socials="sidebar.data.socials"
          view="SIDEBAR"
        />
        <SideBarButtons
          :buttons="sidebar.data.buttons"
        />
        <SideBarArrow
          :arrow="sidebar.data.arrow"
        />
      </div>
    </div>
  </div>
